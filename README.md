...
2. Install Xtext and Xtend from the Eclipse Marketplace.
...
To install via an update site, go to "Help">"Install new software...", then click on "Add" and enter the URL for the update site given above in the URL field, using a suitable label of your choice (e.g., "Henshin nightly") for the name.
