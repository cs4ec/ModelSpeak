 ...
 */
package org.xtext.example.mod.ide.contentassist.antlr;
...
import org.xtext.example.mod.ide.contentassist.antlr.internal.InternalModellingSpeakParser;
import org.xtext.example.mod.services.ModellingSpeakGrammarAccess;

public class ModellingSpeakParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(ModellingSpeakGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ModellingSpeakGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalModellingSpeakParser createParser() {
		InternalModellingSpeakParser result = new InternalModellingSpeakParser(null);
