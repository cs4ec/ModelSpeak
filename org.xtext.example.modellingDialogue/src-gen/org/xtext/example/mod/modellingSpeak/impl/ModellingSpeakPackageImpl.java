...
import org.xtext.example.mod.modellingSpeak.ModellingSpeakFactory;
 ...
 * @generated
 */
public class ModellingSpeakPackageImpl extends EPackageImpl implements ModellingSpeakPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mod.modellingSpeak.ModellingSpeakPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private ModellingSpeakPackageImpl()
  {
    super(eNS_URI, ModellingSpeakFactory.eINSTANCE);
  }
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   *
   * <p>This method is used to initialize {@link ModellingSpeakPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static ModellingSpeakPackage init()
  {
    if (isInited) return (ModellingSpeakPackage)EPackage.Registry.INSTANCE.getEPackage(ModellingSpeakPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredModellingSpeakPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    ModellingSpeakPackageImpl theModellingSpeakPackage = registeredModellingSpeakPackage instanceof ModellingSpeakPackageImpl ? (ModellingSpeakPackageImpl)registeredModellingSpeakPackage : new ModellingSpeakPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theModellingSpeakPackage.createPackageContents();

    // Initialize created meta-data
    theModellingSpeakPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theModellingSpeakPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(ModellingSpeakPackage.eNS_URI, theModellingSpeakPackage);
    return theModellingSpeakPackage;
  }
   ...
   */
  @Override
  public ModellingSpeakFactory getModellingSpeakFactory()
  {
    return (ModellingSpeakFactory)getEFactoryInstance();
  }
