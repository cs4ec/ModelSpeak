 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mod.modellingSpeak.impl.SupportExperimentImpl#getExperiment <em>Experiment</em>}</li>
 *   <li>{@link org.xtext.example.mod.modellingSpeak.impl.SupportExperimentImpl#getTheory <em>Theory</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SupportExperimentImpl extends MoveImpl implements SupportExperiment
{
  ...
  {
    return ModellingSpeakPackage.Literals.SUPPORT_EXPERIMENT;
  }
    ...
    if (experiment != null && experiment.eIsProxy())
    {
      ...
      if (experiment != oldExperiment)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModellingSpeakPackage.SUPPORT_EXPERIMENT__EXPERIMENT, oldExperiment, experiment));
      }
    }
    return experiment;
  }
  ...
  public void setExperiment(Experiment newExperiment)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModellingSpeakPackage.SUPPORT_EXPERIMENT__EXPERIMENT, oldExperiment, experiment));
  }
  ...
  public NotificationChain basicSetTheory(Theory newTheory, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModellingSpeakPackage.SUPPORT_EXPERIMENT__THEORY, oldTheory, newTheory);
  ...
  public void setTheory(Theory newTheory)
  {
    if (newTheory != theory)
    {
      ...
      if (theory != null)
        msgs = ((InternalEObject)theory).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModellingSpeakPackage.SUPPORT_EXPERIMENT__THEORY, null, msgs);
      if (newTheory != null)
        msgs = ((InternalEObject)newTheory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModellingSpeakPackage.SUPPORT_EXPERIMENT__THEORY, null, msgs);
      msgs = basicSetTheory(newTheory, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModellingSpeakPackage.SUPPORT_EXPERIMENT__THEORY, newTheory, newTheory));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ModellingSpeakPackage.SUPPORT_EXPERIMENT__THEORY:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ModellingSpeakPackage.SUPPORT_EXPERIMENT__EXPERIMENT:
