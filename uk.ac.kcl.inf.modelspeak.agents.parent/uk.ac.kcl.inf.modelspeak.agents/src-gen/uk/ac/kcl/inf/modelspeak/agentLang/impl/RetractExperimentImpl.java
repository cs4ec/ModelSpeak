 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.modelspeak.agentLang.impl.RetractExperimentImpl#getExperiment <em>Experiment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RetractExperimentImpl extends MoveImpl implements RetractExperiment
{
  ...
  {
    return AgentLangPackage.Literals.RETRACT_EXPERIMENT;
  }
    ...
    if (experiment != null && experiment.eIsProxy())
    {
      ...
      if (experiment != oldExperiment)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AgentLangPackage.RETRACT_EXPERIMENT__EXPERIMENT, oldExperiment, experiment));
      }
    }
    return experiment;
  }
  ...
  public void setExperiment(Experiment newExperiment)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AgentLangPackage.RETRACT_EXPERIMENT__EXPERIMENT, oldExperiment, experiment));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AgentLangPackage.RETRACT_EXPERIMENT__EXPERIMENT:
