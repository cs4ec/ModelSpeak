...
@Singleton
public class TheoryStoreLangGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class TheoryStoreElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.modelspeak.TheoryStoreLang.TheoryStore");
	...
	public class ElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.modelspeak.TheoryStoreLang.Element");
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.modelspeak.TheoryStoreLang.Model");
	...
	public class TheoryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.modelspeak.TheoryStoreLang.Theory");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RequirementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.modelspeak.TheoryStoreLang.Requirement");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExperimentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "uk.ac.kcl.inf.modelspeak.TheoryStoreLang.Experiment");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	@Inject
	public TheoryStoreLangGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("uk.ac.kcl.inf.modelspeak.TheoryStoreLang".equals(grammar.getName())) {
				return grammar;
			}
